...
3. [Ход работы](#ход-работы)
    1. [Веб-разработка для начинающих](#веб-разработка-для-начинающих)
    2. [Использование Node.js](#создание-приложений-с-помощью-nodejs)
    3. [Использование TypeScript](#создание-приложений-javascript-с-помощью-typescript)
4. [Вывод](#вывод)
...
В ходе выполнения данной работы изучены основы работы
с языками `JavaScript` и `TypeScript`.
